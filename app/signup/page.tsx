      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in px-4">
        <div className="rounded-lg border border-border bg-card p-8 shadow-2xl">
          ...
          <div className="mb-6 text-center">
            <h1 className="text-3xl font-bold tracking-tight text-balance">Create Account</h1>
            <p className="mt-2 text-sm text-muted-foreground">Join the future of herbal authenticity verification</p>
          </div>
